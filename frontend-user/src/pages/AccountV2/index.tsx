...
const AccountV2 = (props: any) => {
  ...
  const { currentTier, totalStaked, totalUnstaked, total } = useUserTier(
    connectedAccount || "",
    "eth"
  );
    ...
    <DefaultLayout>
      {emailVerified === USER_STATUS.UNVERIFIED &&
        ...
        connectedAccount && (
          <div className={classes.alertVerifyEmail}>
            ...
            {!email && (
              <span>
                Your account has not been verified. To verify your account,
                please click on Verify Email button.
              </span>
            )}
            {email && (
              <span>Please go to the mail to verify your account.</span>
            )}
          </div>
        )}
      <div className={classes.accountContainer}>
        <div className={classes.mainContent}>
          ...
          <div className={classes.sectionBot}>
            <Tiers
